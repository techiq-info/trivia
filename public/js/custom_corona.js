...
$(function() {
  $('.firstformnext').click(function(){
    ...
    var Gender = $("#GenderC0 option:selected").val();
    if(Gender == '')
    {
      $('#GenderC0_error').css('display','block');
      $('html, body').animate({
        scrollTop: $("#GenderC0").offset().top -100
      }, 2000);
      return false;
    } else{
      $('#GenderC0_error').css('display','none');
      flag = true;
    }

    var Age = $("#AgeC0 option:selected").val();
    if(Age == '')
    {
      $('#AgeC0_error').css('display','block');
      $('html, body').animate({
        scrollTop: $("#AgeC0").offset().top -100
      }, 2000);
      return false;
    } else{
      $('#AgeC0_error').css('display','none');
      flag = true;
    }

    var HealthCareWorker0 = $("#HealthCareWorker0 option:selected").val();
    if(HealthCareWorker0 == '')
    {
      $('#HealthCareWorker0_error').css('display','block');
      $('html, body').animate({
        scrollTop: $("#HealthCareWorker0").offset().top -100
      }, 2000);
      return false;
    } else{
      $('#HealthCareWorker0_error').css('display','none');
      flag = true;
    }

    var HospitalCash0 = $("#HospitalCash0 option:selected").val();
    if(HospitalCash0 == '')
    {
      $('#HospitalCash0_error').css('display','block');
      $('html, body').animate({
        scrollTop: $("#HospitalCash0").offset().top -100
      }, 2000);
      return false;
    } else{
      $('#HospitalCash0_error').css('display','none');
      flag = true;
    }

    var Gender_spouce = $("#Gender_spouce option:selected").val();
    if(Gender_spouce == '')
    {
      $('#Gender_spouce_error').css('display','block');
      $('html, body').animate({
        scrollTop: $("#Gender_spouce").offset().top -100
      }, 2000);
      return false;
    } else{
      $('#Gender_spouce_error').css('display','none');
      flag = true;
    }

    var Age_spouce = $("#Age_spouce option:selected").val();
    if(Age_spouce == '')
    {
      $('#Age_spouce_error').css('display','block');
      $('html, body').animate({
        scrollTop: $("#Age_spouce").offset().top -100
      }, 2000);
      return false;
    } else{
      $('#Age_spouce_error').css('display','none');
      flag = true;
    }

    var HealthCareWorker_spouce = $("#HealthCareWorker_spouce option:selected").val();
    if(HealthCareWorker_spouce == '')
    {
      $('#HealthCareWorker_spouce_error').css('display','block');
      $('html, body').animate({
        scrollTop: $("#HealthCareWorker_spouce").offset().top -100
      }, 2000);
      return false;
    } else{
      $('#HealthCareWorker_spouce_error').css('display','none');
      flag = true;
    }

    var HospitalCash_spouce = $("#HospitalCash_spouce option:selected").val();
    if(HospitalCash_spouce == '')
    {
      $('#HospitalCash_spouce_error').css('display','block');
      $('html, body').animate({
        scrollTop: $("#HospitalCash_spouce").offset().top -100
      }, 2000);
      return false;
    } else{
      $('#HospitalCash_spouce_error').css('display','none');
      flag = true;
    }

    // var Gender_child = $("#Gender_child option:selected").val();
    // if(Gender_child == '')
    // {
    //   $('#Gender_child_error').css('display','block');
    //   $('html, body').animate({
    //     scrollTop: $("#Gender_child").offset().top -100
    //   }, 2000);
    //   return false;
    // } else{
    //   $('#Gender_child_error').css('display','none');
    //   flag = true;
    // }

    // var Age_child = $("#Age_child option:selected").val();
    // if(Age_child == '')
    // {
    //   $('#Age_child_error').css('display','block');
    //   $('html, body').animate({
    //     scrollTop: $("#Age_child").offset().top -100
    //   }, 2000);
    //   return false;
    // } else{
    //   $('#Age_child_error').css('display','none');
    //   flag = true;
    // }

    // var HospitalCash_child = $("#HospitalCash_child option:selected").val();
    // if(HospitalCash_child == '')
    // {
    //   $('#HospitalCash_child_error').css('display','block');
    //   $('html, body').animate({
    //     scrollTop: $("#HospitalCash_child").offset().top -100
    //   }, 2000);
    //   return false;
    // } else{
    //   $('#HospitalCash_child_error').css('display','none');
    //   flag = true;
    // }

    if (!$('#ResidanceCity').val()) {
      $('#ResidanceCity_error').css('display','block');
      $('html, body').animate({
        scrollTop: $("#ResidanceCity").offset().top -100
      }, 2000);
      return false;
    }else{
      $('#ResidanceCity_error').css('display','none');
      flag = true;
    }

    var PolicyDuration = $("#PolicyDuration option:selected").val();
    if(PolicyDuration == '')
    {
      $('#PolicyDuration_error').css('display','block');
      $('html, body').animate({
        scrollTop: $("#PolicyDuration").offset().top -100
      }, 2000);
      return false;
    } else{
      $('#PolicyDuration_error').css('display','none');
      flag = true;
    }
  ...
  $('.insurancebutton4').click(function(){
    ...
    localStorage.setItem("premium", premium);
    localStorage.setItem("premium_name", "Max Bupa Health Insurance");
    $('#ProposalDetail').css('display','block');
    $('.collapse_button1').removeClass('collapsed');
    $('.collapse_button_div_1').addClass('show');
    $("collapse_button1").attr("aria-expanded","false");
  ...
  $('.insurancebutton6').click(function(){
    ...
    localStorage.setItem("premium", premium);
    localStorage.setItem("premium_name", "New India Insurance");
    $('#ProposalDetail').css('display','block');
    $('.collapse_button1').removeClass('collapsed');
    $('.collapse_button_div_1').addClass('show');
    $("collapse_button1").attr("aria-expanded","false");
  ...
  $('.nextStepButton5').click(function(){
    ...
    $('.collapse_button4').removeClass('collapsed');
    $('.collapse_button_div_4').addClass('show');
    $("collapse_button4").attr("aria-expanded","false");
    $('html, body').animate({
      scrollTop: $(".collapse_button3").offset().top -100
    }, 2000);
  ...
  $('.nextStepButton6').click(function(){
    var flag = false;

    $('.collapse_button4').addClass('collapsed');
    $('.collapse_button_div_4').removeClass('show');
    $("collapse_button4").attr("aria-expanded","true");
